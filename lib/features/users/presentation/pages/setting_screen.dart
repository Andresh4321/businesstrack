        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const PremiumPlansPage()),
              );
            },
            style: ElevatedButton.styleFrom(
        ...
        children: [
          ...
          _buildSettingsTile(
            ...
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Privacy Policy opens in browser'),
                ),
              );
            },
          ),
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            fontSize: 14,
            fontWeight: FontWeight.w600,
            color: isDark ? Colors.grey.shade300 : Colors.blueGrey[800],
            letterSpacing: 0.3,
          ),
        ),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: hintText,
              hintStyle: TextStyle(
                color: isDark ? Colors.grey.shade600 : Colors.blueGrey[300],
              ),
              prefixIcon: Icon(
                icon,
                color: isDark ? Colors.grey.shade400 : Colors.blueGrey[600],
              ),
              filled: true,
              ...
              border: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color: isDark ? Colors.grey.shade700 : Colors.blueGrey[200]!,
                ),
              ),
