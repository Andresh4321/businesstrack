...
void main() {
  ...
  testWidgets('SignupScreen shows all fields and Create Account button', (
    tester,
  ) async {
    await tester.pumpWidget(
  ...
  testWidgets('SettingsScreen shows profile image and settings tiles', (
    tester,
  ) async {
    await tester.pumpWidget(
  ...
  testWidgets('SignupScreen validation shows error for unmatched passwords', (
    tester,
  ) async {
    await tester.pumpWidget(
